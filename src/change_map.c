...
** Last update Sun Jul 24 16:09:41 2016 Dimitri Wyzlic
*/
...
char	**build_list_map()
{
  ...
  if (out == NULL)
    return (NULL);
  out[0] = "maps/level1.ini\0";
  out[1] = "maps/level2.ini\0";
  out[2] = "maps/level3.ini\0";
  out[3] = "maps/level4.ini\0";
  out[4] = "maps/level5.ini\0";
  return (out);
}
